...
inline void TRANSP::receive(packet * pkt) 
{
  ...
  /* [ROTA]Verificação do bit de controle de qual camada de aplicação a mensagem é destinada(radio ou programador) */
  if(pkt->TranspHdr[3] == 1 && FOTA_DEVICE_APL == APL_FOTA_PROG || pkt->TranspHdr[3] == 0 && FOTA_DEVICE_APL == APL_RADIUINO)
  {
